...
class CursoPresencial(SoftDeleteModel):
    ...
    tipo_formulario: Mapped[str] = mapped_column(String(20), default="simples", server_default="simples", nullable=False)
    chave_pix: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
...
class CursoParticipante(SoftDeleteModel):
    ...
    emergencia_contato: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    emergencia_fone: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    ...
    tem_plano_saude: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    plano_saude_nome: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    toma_medicamento: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    medicamentos_nome: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    tem_doenca_tratamento: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    doenca_tratamento_nome: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    tem_diabetes: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    outras_doencas: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    aceita_uso_dados_saude: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false", nullable=False)
    ...
    experiencia_umbanda: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    contato_contexto_espiritual: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    motivo_busca_desenvolvimento: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    interesse_aprendizado: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ja_conhece_terreiro: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    como_conheceu_terreiro: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    tratamento_psiquiatrico: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    tratamento_psiquiatrico_detalhes: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    restricoes_saude: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    aceita_uso_dados: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false", nullable=False)
    aceita_uso_imagem: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false", nullable=False)
    comprovante_inscricao_data: Mapped[Optional[bytes]] = mapped_column(BYTEA, nullable=True)
    comprovante_inscricao_filename: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    comprovante_inscricao_mime: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
